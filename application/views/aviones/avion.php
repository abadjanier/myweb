            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="title-airplane">
                        <h1>McDonell Douglas F4 Phantom II</h1>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="features-airplane">
                        <table class="table">
                            <tbody>
                                <tr>
                                    <td>Motor</td>
                                    <td class="align-right">2 turboreactores General Electric J79-GE</td>
                                </tr>
                                <tr>
                                    <td>Envergadura</td>
                                    <td class="align-right">11,71 m</td>
                                </tr>
                                <tr>
                                    <td>Longitud</td>
                                    <td class="align-right">17,17 m</td>
                                </tr>
                                <tr>
                                    <td>Velocidad Máx.</td>
                                    <td class="align-right">2555 km/h</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>Techo</td>
                                    <td class="align-right">21,650 m</td>
                                </tr>
                                <tr>
                                    <td>Peso</td>
                                    <td class="align-right">21243 kg</td>
                                </tr>
                                <tr>
                                    <td>Primer vuelo</td>
                                    <td class="align-right">27 de mayo de 1958</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
El F-4C de nuestra colección, el 122-13 llegó a Sabadell desmontado y en dos grandes camiones. Actualmente está en proceso de
restauración y montaje.</p>
                    </div>
                </div>
            </div>
        </div>     
